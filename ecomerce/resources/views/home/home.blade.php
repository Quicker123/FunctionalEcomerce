...
<x-home.layout>
    <main id="content" role="main">
        <!-- Slider Section -->
        <div class="mb-4">
            <div class="bg-img-hero" style="background-image: url(/img/1920X422/img2.jpg);">
                        ...
                        <ul class="row list-unstyled products-group no-gutters mb-0 overflow-visible">
                            ...
                            <li class="col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        <div class="col col-lg-auto product-media-left">
                                            <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="/img/150X140/img4.jpg" alt="Image Description"></a>
                                        </div>
                            ...
                            <li class="col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        <div class="col col-lg-auto product-media-left">
                                            <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="/img/150X140/img5.jpg" alt="Image Description"></a>
                                        </div>
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                                <div class="mb-2"><a href="../shop/product-categories-7-column-full-width.html" class="font-size-12 text-gray-5" tabindex="0">Smartwatches</a></div>
                            ...
                            <li class="col-md-4 product-item product-item__card pb-2 mb-2 pb-md-0 mb-md-0 remove-divider">
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner p-md-3 row no-gutters">
                                        <div class="col col-lg-auto product-media-left">
                                            <a href="../shop/single-product-fullwidth.html" class="max-width-150 d-block" tabindex="0"><img class="img-fluid" src="/img/150X140/img7.jpg" alt="Image Description"></a>
                                        </div>
                                        <div class="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                            <div class="mb-4 mb-xl-2 mb-wd-6">
                                            ...
                                            <div class="product-item__inner bg-white p-3">
                                                <div class="product-item__body d-flex flex-column">
                                                    ...
                                                    <div class="mb-1 min-height-8-1">
                                                        <a href="#" class="d-block text-center my-4 mt-lg-6 mb-xl-5 mb-lg-0 mt-xl-0 mb-xl-0 mt-wd-6 mb-wd-5"><img class="img-fluid" src="/img/564X520/img2.jpg" alt="Image Description"></a>
                                                        <!-- Gallery -->
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="/img/300X300/img2.png" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                <h4 class="font-size-18 mb-0 mb-xl-2 font-size-14-down-lg text-center text-md-left">
                    ...
                    <div class="col-4 col-wd-3 border-right remove-bd-wd border-lg-down-0 mb-8">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="/img/300X300/img4.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                <h4 class="font-size-18 mb-0 mb-xl-2 font-size-14-down-lg text-center text-md-left">
                    ...
                    <div class="col-4 col-wd-3 border-right border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="/img/300X300/img7.png" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                <h4 class="font-size-18 mb-0 mb-xl-2 font-size-14-down-lg text-center text-md-left">
                    ...
                    <div class="col-4 col-wd-3 border-lg-down-0 mb-8 d-xl-none d-wd-block">
                        <div class="row align-items-center align-items-xl-start">
                            <div class="col-md-5 mb-3 mb-md-0">
                                <a href="../shop/product-categories-7-column-full-width.html" class="d-block">
                                    <img class="img-fluid" src="/img/300X300/img8.jpg" alt="Image Description">
                                </a>
                            </div>
                            <div class="col-md-7 pl-lg-0">
                                <h4 class="font-size-18 mb-0 mb-xl-2 font-size-14-down-lg text-center text-md-left">
